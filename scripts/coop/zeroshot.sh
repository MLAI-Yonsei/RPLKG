...
do
    ...
    do
        for DATASET in caltech101 ucf101 stanford_cars oxford_pets oxford_flowers food101 fgvc_aircraft dtd eurosat sun397
        do
            ...
            DIR=output_add_shot_16/${CFG}/search_level${SEARCH_LEVEL}_/${DATASET}/shots_${SHOTS}/${TRAINER}/seed${SEED}
